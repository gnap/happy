...
export const ja: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        rebuildMessageCacheConfirm: 'ローカルキャッシュを削除して、サーバーからセッションメッセージを再取得します。続行しますか？',
        rebuildMessageCacheSubtitle: 'ローカルキャッシュを削除してメッセージを再読み込み',
        ...
        lastUpdated: '最終更新',
        sequence: 'シーケンス',
        sequenceSubtitle: 'このセッションのキャッシュ進捗を表示',
