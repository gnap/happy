...
export const ca: TranslationStructure = {
    ...
    status: {
        ...
        error: 'error',
        auth_error: 'Torna a iniciar sessió',
        online: 'en línia',
    ...
    sessionInfo: {
        ...
        rebuildMessageCache: 'Reconstrueix la memòria cau',
        rebuildMessageCacheConfirm: 'Això esborrarà la memòria cau local i tornarà a descarregar els missatges de la sessió des del servidor. Vols continuar?',
        rebuildMessageCacheSubtitle: 'Esborra la memòria cau local i torna a carregar els missatges',
        ...
        sequence: 'Seqüència',
        sequenceSubtitle: 'Mostra el progrés de la memòria cau d’aquesta sessió',
    ...
    agentInput: {
        ...
        codexPermissionMode: {
            ...
            safeYolo: 'Safe YOLO',
            yolo: 'YOLO',
            badgeReadOnly: 'Mode només lectura',
