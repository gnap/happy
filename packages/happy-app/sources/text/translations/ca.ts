...
export const ca: TranslationStructure = {
    ...
    newSession: {
        ...
        sessionReadyMessage: 'Sessió llesta. Toca-la a la llista per obrir-la.',
    },
    ...
    usage: {
        ...
        noBreakdown: 'Sense desglossament per a aquest període.',
        sectionClaude: 'Claude',
        sectionCursor: 'Cursor',
        sectionOther: 'Altres',
        keyTotal: 'Total',
        keyClaudeInput: 'Claude entrada',
        keyClaudeOutput: 'Claude sortida',
