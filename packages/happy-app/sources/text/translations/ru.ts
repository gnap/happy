...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        rebuildMessageCacheConfirm: 'Это очистит локальный кэш и заново загрузит сообщения сессии с сервера. Продолжить?',
        rebuildMessageCacheSubtitle: 'Очистить локальный кэш и загрузить сообщения заново',
        ...
        sequenceSubtitle: 'Показать прогресс кэша для этой сессии',
