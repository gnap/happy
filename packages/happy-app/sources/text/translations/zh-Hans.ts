...
export const zhHans: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        restartSession: '重启会话',
        restartSessionSubtitle: '有新版 CLI 可用，重启以升级。',
        restartSessionConfirm: '会话将使用新版 CLI 重新启动。',
        noMachineId: '此会话没有关联的机器 ID',
        failedToRestartSession: '重启会话失败',
        ...
        quickActions: '快速操作',
        cachedLastSeq: ({ seq }: { seq: number }) => `已缓存最新 seq: ${seq}`,
        viewMachine: '查看设备',
    ...
    usage: {
        ...
        bySource: '按来源',
        noData: '暂无使用数据',
        noBreakdown: '本时段暂无细分数据。',
        sectionClaude: 'Claude',
        sectionCursor: 'Cursor',
        sectionOther: '其他',
        keyTotal: '合计',
        keyClaudeInput: 'Claude 输入',
        keyClaudeOutput: 'Claude 输出',
        ...
        keyCursorPlanLimit: 'Cursor 套餐（额度）',
        keyCursorOnDemandUsed: 'Cursor 按量（已用）',
        keyCursorOnDemandCents: 'Cursor 按量（分）',
        keyCursorOnDemandLimit: 'Cursor 按量（额度）',
        keyCursorOnDemandRemaining: 'Cursor 按量（剩余）',
        keyUnknown: '其他',
    },
