...
export const pl: TranslationStructure = {
    ...
    newSession: {
        ...
        sessionReadyMessage: 'Sesja gotowa. Dotknij jej na liście, aby otworzyć.',
    },
    ...
    session: {
        ...
        encrypting: 'nawiązywanie połączenia…',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Dostępna jest nowsza wersja CLI. Uruchom ponownie, aby zaktualizować.',
        restartSessionConfirm: 'Sesja zostanie uruchomiona ponownie z nowszą wersją CLI.',
        noMachineId: 'ID maszyny niedostępne dla tej sesji',
        failedToRestartSession: 'Nie udało się uruchomić ponownie sesji',
    ...
    tools: {
        ...
        agentView: {
            prompt: 'Prompt',
            agentTools: 'Użyte narzędzia',
            output: 'Wyjście agenta',
            result: 'Wynik',
        },
        multiEdit: {
    ...
    usage: {
        ...
        noBreakdown: 'Brak rozbicia na ten okres.',
        sectionClaude: 'Claude',
        sectionCursor: 'Cursor',
        sectionOther: 'Inne',
        keyTotal: 'Suma',
        keyClaudeInput: 'Claude wejście',
        keyClaudeOutput: 'Claude wyjście',
        keyClaudeCacheCreation: 'Claude cache (zapis)',
        keyClaudeCacheRead: 'Claude cache (odczyt)',
        keyCursorPlanUsed: 'Cursor plan (użyto)',
        keyCursorPlanLimit: 'Cursor plan (pozostało)',
        keyCursorOnDemandUsed: 'Cursor na żądanie (użyto)',
        keyCursorOnDemandLimit: 'Cursor na żądanie (centy)',
        keyCursorPlanRemaining: 'Cursor plan (pozostało)',
        keyCursorOnDemandCents: 'Cursor na żądanie (centy)',
        keyCursorOnDemandRemaining: 'Cursor na żądanie (pozostało)',
        keyUnknown: 'Inne',
    },
