...
export const pl: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        rebuildMessageCacheConfirm: 'To wyczyści lokalną pamięć podręczną i ponownie pobierze wiadomości sesji z serwera. Kontynuować?',
        rebuildMessageCacheSubtitle: 'Wyczyść lokalną pamięć podręczną i załaduj wiadomości ponownie',
        ...
        sequence: 'Sekwencja',
        sequenceSubtitle: 'Pokaż postęp pamięci podręcznej tej sesji',
    ...
    agentInput: {
        ...
        codexPermissionMode: {
            ...
            safeYolo: 'Safe YOLO',
            yolo: 'YOLO',
            badgeReadOnly: 'Tryb tylko do odczytu',
