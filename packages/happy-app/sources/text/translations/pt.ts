...
export const pt: TranslationStructure = {
    ...
    newSession: {
        ...
        sessionReadyMessage: 'Sessão pronta. Toque nela na lista para abrir.',
    },
    ...
    session: {
        ...
        encrypting: 'estabelecendo conexão…',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Uma versão mais recente do CLI está disponível. Reinicie para atualizar.',
        restartSessionConfirm: 'A sessão será reiniciada com a versão mais recente do CLI.',
        noMachineId: 'ID da máquina não disponível para esta sessão',
        ...
        sequence: 'Sequência',
        sequenceSubtitle: 'Seq interno de mensagens da sessão (monótono por sessão; igual ao Session.seq do servidor)',
        ...
        rebuildMessageCache: 'Reconstruir cache de mensagens',
        rebuildMessageCacheSubtitle: 'Limpar mensagens em cache e recarregar do servidor',
        cachedLastSeq: ({ seq }: { seq: number }) => `Último seq em cache: ${seq}`,
        rebuildMessageCacheConfirm: 'Isso limpará o cache local de mensagens e recarregará todas as mensagens do servidor. Continuar?',
    ...
    agentInput: {
        ...
        cursorPermissionMode: {
            title: 'MODO DE EXECUÇÃO CURSOR',
            default: 'Padrão',
            plan: 'Plano (somente leitura)',
            ask: 'Perguntas (Q&A)',
            force: 'Forçar permissões',
            badgePlan: 'Plano',
            badgeAsk: 'Perguntas',
            badgeForce: 'Forçar',
        },
    ...
    usage: {
        ...
        noBreakdown: 'Sem detalhamento para este período.',
        sectionClaude: 'Claude',
        sectionCursor: 'Cursor',
        sectionOther: 'Outros',
        keyTotal: 'Total',
        keyClaudeInput: 'Claude entrada',
        keyClaudeOutput: 'Claude saída',
        keyClaudeCacheCreation: 'Claude cache (escrita)',
        keyClaudeCacheRead: 'Claude cache (leitura)',
        keyCursorPlanUsed: 'Cursor plano (usado)',
        keyCursorPlanLimit: 'Cursor plano (restante)',
        keyCursorOnDemandUsed: 'Cursor sob demanda (usado)',
        keyCursorOnDemandLimit: 'Cursor sob demanda (centavos)',
        keyCursorPlanRemaining: 'Cursor plano (restante)',
        keyCursorOnDemandCents: 'Cursor sob demanda (centavos)',
        keyCursorOnDemandRemaining: 'Cursor sob demanda (restante)',
        keyUnknown: 'Outros',
    },
