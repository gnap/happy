...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        rebuildMessageCache: 'Recriar cache de mensagens',
        rebuildMessageCacheConfirm: 'Isso vai limpar o cache local e buscar novamente as mensagens da sessão no servidor. Continuar?',
        rebuildMessageCacheSubtitle: 'Limpar o cache local e carregar as mensagens novamente',
        ...
        sequence: 'Sequência',
        sequenceSubtitle: 'Mostra o progresso do cache desta sessão',
    ...
    agentInput: {
        ...
        codexPermissionMode: {
            ...
            safeYolo: 'Safe YOLO',
            yolo: 'YOLO',
            badgeReadOnly: 'Modo somente leitura',
