...
export const es: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        rebuildMessageCacheConfirm: 'Esto borrará la caché local y volverá a descargar los mensajes de la sesión desde el servidor. ¿Continuar?',
        rebuildMessageCacheSubtitle: 'Borra la caché local y vuelve a cargar los mensajes',
        ...
        sequence: 'Secuencia',
        sequenceSubtitle: 'Muestra el progreso de la caché de esta sesión',
    ...
    agentInput: {
        ...
        codexPermissionMode: {
            ...
            safeYolo: 'Safe YOLO',
            yolo: 'YOLO',
            badgeReadOnly: 'Modo solo lectura',
