...
export const es: TranslationStructure = {
    ...
    session: {
        ...
        encrypting: 'estableciendo conexión…',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Hay una versión más reciente del CLI disponible. Reinicia para actualizar.',
        restartSessionConfirm: 'La sesión se reiniciará con la versión más reciente del CLI.',
        noMachineId: 'ID de máquina no disponible para esta sesión',
    ...
    tools: {
        ...
        agentView: {
            prompt: 'Prompt',
            agentTools: 'Herramientas usadas',
    ...
    usage: {
        ...
        noBreakdown: 'Sin desglose para este período.',
        sectionClaude: 'Claude',
        sectionCursor: 'Cursor',
        sectionOther: 'Otros',
        keyTotal: 'Total',
        keyClaudeInput: 'Claude entrada',
        keyClaudeOutput: 'Claude salida',
        keyClaudeCacheCreation: 'Claude caché (escritura)',
        keyClaudeCacheRead: 'Claude caché (lectura)',
        keyCursorPlanUsed: 'Cursor plan (usado)',
