...
export const it: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        rebuildMessageCacheConfirm: 'Questo cancellerà la cache locale e scaricherà di nuovo i messaggi della sessione dal server. Continuare?',
        rebuildMessageCacheSubtitle: 'Cancella la cache locale e ricarica i messaggi',
        ...
        sequence: 'Sequenza',
        sequenceSubtitle: 'Mostra l’avanzamento della cache di questa sessione',
