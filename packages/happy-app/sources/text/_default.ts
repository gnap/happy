...
export const en = {
    ...
    sessionInfo: {
        ...
        rebuildMessageCacheConfirm: 'This will clear the local cache and refetch the session messages from the server. Continue?',
        rebuildMessageCacheSubtitle: 'Clear the local cache and fetch the messages again',
        ...
        sequence: 'Sequence',
        sequenceSubtitle: 'View the cache progress for this session',
